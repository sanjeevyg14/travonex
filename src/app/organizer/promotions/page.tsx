        ...
        <Dialog open={isOpen} onOpenChange={setIsOpen}>
            ...
            <DialogContent className="sm:max-w-[425px]">
                <DialogHeader>
                    ...
                    <DialogDescription>
                        Create a custom discount code for your trips.
                    </DialogDescription>
                </DialogHeader>
                ...
                <CardContent>
                    {organizerCoupons.length > 0 ? (
                        ...
                        <div className="text-center py-12">
                            ...
                            <h3 className="text-lg font-semibold mt-4">No coupons created yet.</h3>
                            <p className="text-muted-foreground mt-2">Click "Create New Coupon" to get started.</p>
                        </div>
                    )}
                </CardContent>
            </Card>
