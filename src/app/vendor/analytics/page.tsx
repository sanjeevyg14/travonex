    ...
    return (
         <div className="space-y-8">
            <div>
                ...
                <p className="text-muted-foreground">Insights into your single-day activity performance.</p>
            </div>
            ...
            <div className="grid gap-4 md:grid-cols-2 lg:grid-cols-4">
             ...
             <Card>
                <CardHeader>
                    ...
                    <CardDescription>Gross revenue from experiences over the last 6 months.</CardDescription>
                </CardHeader>
                <CardContent>
